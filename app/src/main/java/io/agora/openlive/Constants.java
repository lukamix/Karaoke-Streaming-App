...
public class Constants {
    ...
    public static final int DEFAULT_PROFILE_IDX = 5; // Default 2 here. NBĐ changed
    ...
    public static final String VIDEO_SOURCE_EXP = "/storage/emulated/0/Download/y2mate.com - Bomman Khóc Thét   Bomman Autotune_360p.mp4";
}
